...
```bash
git clone https://github.com/linuxdil/Sowing-Taker-Bot.git
cd Sowing-Taker-Bot
```
...
Contributions, issues, and feature requests are welcome. Feel free to check [issues page](https://github.com/LinuxDil/Sowing-Taker-Bot/issues) if you want to contribute.
